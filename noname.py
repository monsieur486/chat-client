...
class AppFrame ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        m_radioBox3Choices = [ u"Actifs", u"Ne pas déranger" ]
        self.m_radioBox3 = wx.RadioBox( self.connexionTab, wx.ID_ANY, u"Messages Privés", wx.DefaultPosition, wx.DefaultSize, m_radioBox3Choices, 1, wx.RA_SPECIFY_COLS )
