...
class AppFrame ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"AppPubSub", pos = wx.DefaultPosition, size = wx.Size( 364,636 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
        ...
        self.chatView = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.HSCROLL|wx.TE_MULTILINE|wx.TE_READONLY )
        ...
        self.Bind( wx.EVT_MENU, self.onMenuChange, id = self.menuChangeMode.GetId() )
